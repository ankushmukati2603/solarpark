...
class LoginController extends Controller
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->middleware('guest:stu-users')->except('logout');
    }
    ...
    public function login(Request $request)
    {
        ...
        if($request->user_type=='STATEIMPLEMENTINGAGENCY' || $request->user_type=='SECI' || $request->user_type=='REIA' || $request->user_type=='STU' || $request->user_type=='MNRE')
        {
            // dd($request);
    ...
    public function logout(Request $request)
    {
        ...
        }elseif(Auth::guard('stu-users')->check()){
            Auth::guard('stu-users')->logout();
        }else{
            Auth::guard()->logout();
        }
        // $url = urlencode('/');
