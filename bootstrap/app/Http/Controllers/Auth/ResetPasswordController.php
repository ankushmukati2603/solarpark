...
class ResetPasswordController extends Controller
{
    ...
    */
    ...
    public function reset(Request $request)
    {
        switch ($request->user_type) {
            ...
            case 'STATEIMPLEMENTINGAGENCY':
                ...
                break;
            case 'LOCALBODY':
                $this->redirectTo = '/localbody';
                break;
            case 'INSTALLER':
                $this->redirectTo = '/installer';
                break;
            case 'INSPECTOR':
        ...
        if(!$this->passwordPolicyTest($request->password)){
    ...
    public function broker($request)
    {
        switch ($request->user_type) {
            case 'MNRE':
                return Password::broker('mnre_users');
                break;
            case 'STATEIMPLEMENTINGAGENCY':
                return Password::broker('state_implementing_agency_users');
                break;
            case 'LOCALBODY':
                return Password::broker('localbody_users');
                break;
            case 'INSTALLER':
                return Password::broker('installers');
                break;
            case 'INSPECTOR':
