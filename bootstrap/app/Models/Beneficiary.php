...
public static function getMnreUsers(){
    ...
    $data=self::select('beneficiary.*','states.name as state_name','districts.name as district_name','sub_districts.name as sub_districts_name','villages.name as village_name'
    )
    ...
    ->join('villages','villages.code','beneficiary.village')->get();
