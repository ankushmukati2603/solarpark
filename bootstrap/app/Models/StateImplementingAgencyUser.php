...
class StateImplementingAgencyUser extends Authenticatable
{
    ...
    public static function getMnreagencyUsers(){
   
        $data=self::select('state_implementing_agency_users.*','states.name as state_name','districts.name as district_name','sub_districts.name as sub_districts_name','villages.name as village_name'
        )
        ...
        ->join('villages','villages.code','state_implementing_agency_users.village')->get();
