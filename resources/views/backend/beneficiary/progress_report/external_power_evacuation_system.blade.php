<div id="home" class=" tab-pane active"><br>
    <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('external_power_system','{{$generalData["month"]}}','{{$generalData["year"]}}','{{$generalData["id"]}}')">
        Same
        as Previous Month
        <br>
    </div>
    ...
    <div class="col-md-12 pb-4">
        ...
        <textarea name="external_transmission" id="" cols="10" class="form-control"
            rows="3">{{($generalData['external_power_evacuation_system']['external_transmission'] ?? '')}}</textarea>
    ...
    <div class="col-md-12 pb-4">
        ...
        <textarea name="delay_external_transmission" id="" cols="10" class="form-control"
            rows="3">{{($generalData['external_power_evacuation_system']['delay_external_transmission'] ?? '')}}</textarea>
    ...
    <div class="col-md-12 pb-4">
        ...
        <textarea name="external_transmission_remarks" id="" cols="10" class="form-control"
            rows="3">{{($generalData['external_power_evacuation_system']['external_transmission_remarks'] ?? '')}}</textarea>
