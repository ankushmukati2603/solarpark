<div id="home" class=" tab-pane active"><br>
    <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('financial_closure','{{$generalData["month"]}}','{{$generalData["year"]}}','{{$generalData["id"]}}')">
        Same
        as Previous Month
        <br>
    </div>
    ...
    <div class="col-md-12 pb-4">
        ...
        <textarea name="financial_closure_details" id="" cols="10" class="form-control"
            rows="3">{{$generalData['financial_closure']['financial_closure_details'] ?? ''}}</textarea>
    </div>
    <div class="col-md-12">
        ...
        <textarea name="financial_closure_remarks" id="" cols="10" class="form-control"
            rows="3">{{$generalData['financial_closure']['financial_closure_remarks'] ?? ''}}</textarea>
    </div>
</div>