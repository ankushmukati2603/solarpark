<div id="home" class=" tab-pane active"><br>
    <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('internal_infrastructure','{{$generalData["month"]}}','{{$generalData["year"]}}','{{$generalData["id"]}}')">
        Same
        as Previous Month
        <br>
    </div>
        ...
        <div class="form-check-inline col-md-2">
            <label class="form-check-label">
                ...
                <input type="radio" class="form-check-input" name="dpr_status" value="B"
                    @if(($generalData['internal_infrastructure']['dpr_status'] ?? '' )=='B' ) checked @endif> DPR
                Submitted
            </label>
        </div>
        <div class="form-check-inline col-md-2">
        ...
        <div class="form-check-inline col-md-2">
            <label class="form-check-label">
                <input type="radio" class="form-check-input" name="dpr_status" value="D"
                    @if(($generalData['internal_infrastructure']['dpr_status'] ?? '' )=='D' ) checked @endif> DPR
                Approved
            </label>
        </div>
    </div> -->
    ...
    <div class="col-md-12 form-inline row">
        <div class="col-md-4 col-sm-12">
            ...
            <input type="text" name="land_status_identified" id="txtContact" placeholder="Land Identified (In Acres)"
                class="form-control"
                value="{{$generalData['internal_infrastructure']['land_status_identified'] ?? ''}}">
            <span class="text-danger">{{ $errors->first('land_status_identified') }}</span>
        </div>
        <div class="col-md-4 col-sm-12">
            ...
            <input type="text" name="land_status_aquired" id="txtContact" placeholder="Land Acquired (In Acres)"
                class="form-control" value="{{$generalData['internal_infrastructure']['land_status_aquired'] ?? ''}}">
            <span class="text-danger">{{ $errors->first('land_status_aquired') }}</span>
        </div>
    </div>
    ...
    <div class="col-md-4 form-check-inline">
        <div class="col-md-12 pb-4"><label for="">Government Land Identified</label>
            <input type="text" class="form-control" placeholder="Government Land Identified" name="govt_land_identified"
                value="{{$generalData['internal_infrastructure']['govt_land_identified'] ?? ''}}">
        </div>
        <div class="col-md-12 pb-4"><label for="">Government Land Acquired</label>
            <input type="text" class="form-control" placeholder="Government Land Acquired" name="govt_land_acquired"
                value="{{$generalData['internal_infrastructure']['govt_land_acquired'] ?? ''}}">
        </div>
    </div>
    <div class="col-md-4 form-check-inline">
        <div class="col-md-12 pb-4"><label for="">Private Land Acquired</label>
            <input type="text" class="form-control" name="private_land_acquired" placeholder="Private Land Acquired"
                value="{{$generalData['internal_infrastructure']['private_land_acquired'] ?? ''}}">
        </div>
        <div class="col-md-12 pb-4"><label for="">Private Land Identified</label>
            <input type="text" class="form-control" name="private_land_identified" placeholder="Private Land Identified"
                value="{{$generalData['internal_infrastructure']['private_land_identified'] ?? ''}}">
        </div>
    </div>
    <div class="clearfix"></div><br>
    <div class="col-md-4 col-sm-12">
    ...
    <div class="form-check-inline">
        <label class="form-check-label">
            <input type="radio" class="form-check-input" name="road_status" value="A"
                @if(($generalData['internal_infrastructure']['road_status'] ?? '' )=='A' ) checked @endif checked>
            Already available
        </label>
    </div>
    <div class="form-check-inline">
        <label class="form-check-label">
            <input type="radio" class="form-check-input" name="road_status" value="B"
                @if(($generalData['internal_infrastructure']['road_status'] ?? '' )=='B' ) checked @endif>New road to be
            developed
        </label>
    </div>
    <div class="form-check-inline">
        <label class="form-check-label">
            <input type="radio" class="form-check-input" name="road_status" value="C"
                @if(($generalData['internal_infrastructure']['road_status'] ?? '' )=='C' ) checked @endif>Only
...
<div class="row col-md-12">
    <div class="col-md-6 pb-4">
        ...
        <input type="number" min="0" step="any" name="park_boundary" id="txtContact" class="form-control  number"
            value="{{($generalData['internal_infrastructure']['park_boundary'] ?? '' )}}">
    ...
    <div class="col-md-6 pb-4">
        ...
        <input type="number" min="0" step="any" name="road_distance" id="txtContact" class="form-control  number"
            value="{{($generalData['internal_infrastructure']['road_distance'] ?? '' )}}">
...
<div class="row col-md-12">
    <div class="col-md-6">
        ...
        <textarea type="text" name="work_status" id="" class="form-control" cols="10" rows="3"
            value="{{($generalData['internal_infrastructure']['work_status'] ?? '' )}}">{{($generalData['internal_infrastructure']['work_status'] ?? '' )}}</textarea>
...
<div class="col-md-12 form-inline row">
    <div class="col-md-6 col-sm-12">
        ...
        <input type="text" name="source_water" id="txtName" class="form-control"
            value="{{($generalData['internal_infrastructure']['source_water'] ?? '')}}">
    </div>
    <!-- <div class="clearfix"><br></div> -->
    <div class="col-md-6 col-sm-12">
        ...
        <textarea name="required_water" id="" cols="10" class="form-control"
            rows="3">{{($generalData['internal_infrastructure']['required_water'] ?? '')}}</textarea>
    </div>
    <div class="clearfix"></div><br>
    <div class="col-md-6 col-sm-12">
        ...
        <textarea name="proposed_system" id="" cols="10" class="form-control"
            rows="3">{{($generalData['internal_infrastructure']['proposed_system'] ?? '')}}</textarea>
    </div>
    <div class="col-md-6 col-sm-12">
        <label>
        ...
        <textarea name="status" id="" cols="10" class="form-control"
            rows="3">{{($generalData['internal_infrastructure']['status'] ?? '')}}</textarea>
    </div>
...
<div class="col-md-12 form-inline row">
    <div class="col-md-6 col-sm-12">
        ...
        <textarea name="drainage_system_details" id="" cols="10" class="form-control"
            rows="3">{{($generalData['internal_infrastructure']['drainage_system_details'] ?? '')}}</textarea>
    ...
    <div class="col-md-6 col-sm-12">
        ...
        <textarea name="tender_status" id="" cols="10" class="form-control"
            rows="3">{{($generalData['internal_infrastructure']['tender_status'] ?? '')}}</textarea>
    ...
    <div><br>
        ...
        <div class="col-md-12 form-inline row">
            <div class="col-md-6 col-sm-12">
                ...
                <textarea name="fencing_details" id="" cols="10" rows="3" class="form-control"
                    value="{{$generalData['internal_infrastructure']['fencing_details'] ?? ''}}">{{$generalData['internal_infrastructure']['fencing_details'] ?? ''}}</textarea>
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <textarea name="fencing_status" id="" cols="10" rows="3" class="form-control"
                    value="{{$generalData['internal_infrastructure']['fencing_status'] ?? ''}}">{{$generalData['internal_infrastructure']['fencing_status'] ?? ''}}</textarea>
        ...
        <div class="col-md-12 form-inline row">
            <div class="col-md-6 col-sm-12">
                ...
                <textarea name="tele_facility_details" id="" cols="10" class="form-control"
                    rows="3">{{$generalData['internal_infrastructure']['tele_facility_details'] ?? ''}}</textarea>
            ...
            <div class="col-md-6 col-sm-12">
                ...
                <textarea name="tender_progress_status" id="" cols="10" class="form-control"
                    rows="3">{{$generalData['internal_infrastructure']['tender_progress_status'] ?? ''}}</textarea>
        ...
        <div class="col-sm-12">
            ...
            <textarea name="telecomunication_remark" id="" cols="10" class="form-control"
                rows="3">{{$generalData['internal_infrastructure']['telecomunication_remark'] ?? ''}}</textarea>
