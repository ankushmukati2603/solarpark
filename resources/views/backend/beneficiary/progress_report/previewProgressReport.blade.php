    ...
    <main id="main" class="main">
        ...
        <table border="1" cellspacing="0" cellpadding="5" class="table table-bordered table-striped text-left">
            ...
            <tr>
                ...
                <td>{{$previewData['general']['ceo_mail'] ?? ''}}</td>
            ...
            <tr>
                ...
                <td>{{$previewData['general']['ceo_contact_number'] ?? ''}}</td>
            </tr>
            <tr>
                <th colspan="4" class="heading">
            ...
            <tr>
                ...
                <td>{{$previewData['internal_infrastructure']['govt_land_identified'] ?? ''}}</td>
                <th>Government Land Acquired</th>
                <td>{{$previewData['internal_infrastructure']['govt_land_acquired'] ?? ''}}</td>
            </tr>
            <tr>
                <th>Private Land Acquired</th>
                <td>{{$previewData['internal_infrastructure']['private_land_acquired'] ?? ''}}</td>
                <th>Private Land Identified</th>
                <td>{{$previewData['internal_infrastructure']['private_land_identified'] ?? ''}}</td>
            </tr>
            <tr>
                <th>Any Others</th>
        ...
        <td>{{$previewData['financial_closure']['financial_closure_remarks']  ?? ''}}</td> -->
            ...
            <tr>
                ...
                <td colspan="4">
                    @if($previewData['project_report_detail']!='')

                    <a href=" {{URL::to($docBaseUrl.$previewData['project_report_detail'])}}" target="_blank"
                        style='float: right;'>View File</a>
                    @endif
            ...
            <tr>
                ...
                <td colspan="4">
                    @if($previewData['expenditure_statement']!='')

                    <a href=" {{URL::to($docBaseUrl.$previewData['expenditure_statement'])}}" target="_blank"
                        style='float: right;'>View File</a>
                    @endif
                </td>
            <tr>
