...
<strong>
    <h1 class="text-center">Development of Solar Parks and Ultra Mega Solar Power Projects</h1>
</strong>
<strong>
...
@endif
<form action="{{url(Auth::getDefaultDriver().'/my-progress-report')}}" method="post">@csrf
    <div class="col-md-12">
        <div class="col-md-3">
    ...
    <div class="col-md-3 col-sm-12">
        ...
        <input type="number" step="any" min="0" name="capacity" id="txtgeneralLatitude" class="form-control" value="">
