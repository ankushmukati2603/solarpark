...
<table border="1" cellspacing="0" cellpadding="5" class="table table-bordered table-striped text-left">
    ...
    <tr>
        ...
        <th>State</th>
        <td>{{$previewData['general']['state'] ?? ''}}</td>

    </tr>
    <tr>
        <th>District</th>
        <td>{{$previewData['general']['district'] ?? ''}}</td>
        <th>Sub District</th>
        <td>{{$previewData['general']['sub_district'] ?? ''}}</td>
    </tr>
    <tr>
        <th>Village</th>
        <td>{{$previewData['general']['village'] ?? ''}}</td>
        <th>Latitude</th>
    ...
    <tr>
        ...
        <td> @if($previewData['internal_infrastructure']['dpr_status'] == 'A')
            ...
            @else
            $previewData['internal_infrastructure']['dpr_status'] == 'D'
