<div id="home" class=" tab-pane active"><br>
    <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('road','{{$generalData["month"]}}','{{$generalData["year"]}}','{{$generalData["id"]}}')">
        Same
        as Previous Month
        <br>
    </div>
    ...
    <div class="row col-md-12">
        <div class="col-md-6">
            ...
            <textarea type="text" name="work_status" id="" class="form-control" cols="10" rows="5"
        ...
        <div class="col-md-6">
            ...
            <textarea name="road_remarks" id="" cols="10" class="form-control" rows="5"
