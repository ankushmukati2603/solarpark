<div id="home" class=" tab-pane active"><br>
    <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('solar_project_completion','{{$generalData["month"]}}','{{$generalData["year"]}}','{{$generalData["id"]}}')">
        Same
        as Previous Month
        <br>
    </div>
    ...
    <div class="col-md-12 pb-4">
        ...
        <textarea name="solar_project_completion_details" id="" cols="10" class="form-control"
            rows="3">{{$generalData['solar_project_completion']['solar_project_completion_details'] ?? ''}}</textarea>
    ...
    <div class="col-md-12 pb-4">
        ...
        <textarea name="delay_solar_project" id="" cols="10" class="form-control"
            rows="3">{{$generalData['solar_project_completion']['delay_solar_project'] ?? ''}}</textarea>
    ...
    <div class="col-md-12 pb-4">
        ...
        <textarea name="solar_project_complation_remarks" id="" cols="10" class="form-control"
            rows="3">{{$generalData['solar_project_completion']['solar_project_complation_remarks'] ?? ''}}</textarea>
