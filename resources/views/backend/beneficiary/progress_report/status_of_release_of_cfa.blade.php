<div id="home" class=" tab-pane active">
    ...
    <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('status_of_release_of_cfa','{{$generalData["month"]}}','{{$generalData["year"]}}','{{$generalData["id"]}}')">
        Same
        as Previous Month
        <br>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td class="row-index text-center"> <input type="number" min="0" name="land_acquisition_amount"
                    class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['land_acquisition_amount'] ?? ''}}">
            </td>
            <td><input type="date" name="land_acquisition_due_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['land_acquisition_due_date'] ?? ''}}"></td>
            <td><input type="date" name="land_acquisition_release_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['land_acquisition_release_date'] ?? ''}}"></td>
        </tr>
        <tr>
            <td>2</td>
            ...
            <td> <input type="number" min="0" name="financial_closure_amount" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['financial_closure_amount'] ?? ''}}"></td>
            <td><input type="date" name="financial_closure_due_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['financial_closure_due_date'] ?? ''}}"></td>
            <td><input type="date" name="financial_closure_release_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['financial_closure_release_date'] ?? ''}}"></td>
        </tr>
        <tr>
            <td>3</td>
            ...
            <td><input type="number" min="0" name="aw_pooling_station_amount" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['aw_pooling_station_amount'] ?? ''}}"></td>
            <td><input type="date" name="aw_pooling_station_due_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['aw_pooling_station_due_date'] ?? ''}}"></td>
            <td><input type="date" name="aw_pooling_station_release_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['aw_pooling_station_release_date'] ?? ''}}"></td>
        </tr>
        <tr>
            <td>4</td>
            ...
            <td><input type="number" min="0" name="receipt_material_site_amount" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['receipt_material_site_amount'] ?? ''}}"></td>
            <td><input type="date" name="receipt_material_site_due_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['receipt_material_site_due_date'] ?? ''}}"></td>
            <td><input type="date" name="receipt_material_site_release_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['receipt_material_site_release_date'] ?? ''}}">
            </td>
        ...
        <tr>
            ...
            <td><input type="number" min="0" name="completion_construction_amount" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['completion_construction_amount'] ?? ''}}"></td>
            <td><input type="date" name="completion_construction_due_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['completion_construction_due_date'] ?? ''}}"></td>
            <td><input type="date" name="completion_construction_release_date" class="form-control"
                    value="{{$generalData['status_of_release_of_cfa']['completion_construction_release_date'] ?? ''}}">
            </td>
        </tr>
        <tr>
