                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="tabUL">
                            <li class=""><a href="#general" role="tab" data-toggle="tab">General</a></li>
                            <li class=""><a href="#internal_infrastructure" role="tab" data-toggle="tab">Internal
                                    Infrastructure</a>
                            </li>
                            <!-- <li class="@if(['road']!='')completed @endif"><a href="#road" role="tab"
                                    data-toggle="tab">Road</a></li>
                            <li class="@if(['water_facilities']!='')completed @endif"><a href="#water_facilities"
                                    role="tab" data-toggle="tab">Water Facilities</a></li>
                            <li class="@if(['drainage_system']!='')completed @endif"><a href="#drainage_system"
                                    role="tab" data-toggle="tab">Drainage System</a></li>
                            <li class="@if(['fencing_boundary']!='')completed @endif"><a href="#fencing_boundary"
                                    role="tab" data-toggle="tab">Fencing Boundary</a></li>
                            <li class="@if(['telecommunication_facilities']!='')completed @endif"><a
                                    href="#telecommunication_facilities" role="tab" data-toggle="tab">Telecommunication
                                    Facilities</a>
                            </li>
                            <li class="@if(['internal_transmission_system']!='')completed @endif"><a
                                    href="#internal_transmission_system" role="tab" data-toggle="tab">Internal
                                    Transmission
                                    System</a>
                            </li>
                            <li class="@if(['external_transmission_system']!='')completed @endif"><a
                                    href="#external_transmission_system" role="tab" data-toggle="tab">External
                                    Transmission
                                    System</a>
                            </li>
                            <li class="@if(['solar_projects']!='')completed @endif"><a href="#solar_projects" role="tab"
                                    data-toggle="tab">Solar Projects</a></li>
                            <li class="@if(['financial_closure']!='')completed @endif"><a href="#financial_closure"
                                    role="tab" data-toggle="tab">Financial Closure</a></li>
                            <li class="@if(['award_of_work']!='')completed @endif"><a href="#award_of_work" role="tab"
                                    data-toggle="tab">Award of Work</a></li>
                            <li class="@if(['solar_park_completion']!='')completed @endif"><a
                                    href="#solar_park_completion" role="tab" data-toggle="tab">Solar Park Completion</a>
                            </li>
                            <li class="@if(['external_power_evacuation_system']!='')completed @endif"><a
                                    href="#external_power_evacuation_system" role="tab" data-toggle="tab">External Power
                                    Evacuation System</a>
                            </li>
                            <li class="@if(['solar_project_completion']!='')completed @endif"><a
                                    href="#solar_project_completion" role="tab" data-toggle="tab">Solar Project
                                    Completion</a>
                            </li>
                            <li class="@if(['attachments']!='')completed @endif"><a href="#attachments" role="tab"
                                    data-toggle="tab">Attachments</a></li>
                            <li class="@if(['additional_information']!='')completed @endif"><a
                                    href="#additional_information" role="tab" data-toggle="tab">Additional
                                    Information</a></li>
                            <li class=""><a href="#final_submission" role="tab" data-toggle="tab">Final Submission</a>
                            </li>
                        </ul> -->
                            <!-- Tab panes -->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="general">
                                    <form
                                        action="{{ URL::to(Auth::getDefaultDriver().'/solar_power/solarPowerReport') }}"
                                        method="POST" enctype="multipart/form-data" id="formFileAjax" name="general">
                                        <input type="hidden" name="editId" value="{{$id ?? ''}}">
                                        @csrf
                                        @include('backend/beneficiary/solar_power/project_type/general')
                                ...
                                <div class="tab-pane" id="internal_infrastructure">
                                    <!-- <form
                                        action="{{ URL::to(Auth::getDefaultDriver().'/application/progress_report') }}"
                                    ...
                                    <form
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="submit" name="submit_road" id="submit_road" value="Save"
                                                class="btn btn-flat btn-success" />
                                            <button type="button" data-next="water_facilities"
                                                class="btn btn-flat btn-primary"
                                                onClick="$('.nav-tabs > .active').next('li').find('a').trigger('click');"
                                                value="1" name="road"> Next</button>
                                        </div>
                                ...
                                <div class="tab-pane" id="water_facilities">
                                    <form
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <button type="button" class="btn btn-flat btn-danger"
                                                onClick="$('.nav-tabs > .active').prev('li').find('a').trigger('click');"
                                                value="1" name="road"> Back</button>
                                            <input type="submit" name="submit_water_facilities"
                                                id="submit_water_facilities" value="Save"
                                                class="btn btn-flat btn-success" />

                                            <button type="button" data-next="drainage_system"
                                                class="btn btn-flat btn-primary"
                                                onClick="$('.nav-tabs > .active').next('li').find('a').trigger('click');"
                                                value="1" name="water_facilities"> Next</button>
                                        </div>
                                        <div>
                                            <br><br><br>
                                            <div class="clearfix"></div>
                                ...
                                <div class="tab-pane" id="drainage_system">
                                    <form
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <button type="button" class="btn btn-flat btn-danger"
                                                onClick="$('.nav-tabs > .active').prev('li').find('a').trigger('click');"
                                                value="1" name="water_facilities"> Back</button>

                                            <input type="submit" name="submit_drainage_system"
                                                id="submit_drainage_system" value="Save"
                                                class="btn btn-flat btn-success" />

                                            <button type="button" data-next="fencing_boundary"
                                                class="btn btn-flat btn-primary"
                                                onClick="$('.nav-tabs > .active').next('li').find('a').trigger('click');"
                                                value="1" name="drainage_system"> Next</button>
                                        </div>
                                        <div>
                                            <br><br><br>
                                            <div class="clearfix"></div>
                                ...
                                <div class="tab-pane" id="fencing_boundary">
                                    <form
                                        ...
                                        <div class="col-md-3 pt-15">
                                            ...
                                            <button type="button" class="btn btn-flat btn-danger"
                                                onClick="$('.nav-tabs > .active').prev('li').find('a').trigger('click');"
                                                value="1" name="drainage_system"> Back</button>

                                            <input type="submit" name="submit_fencing_boundary"
                                                id="submit_fencing_boundary" value="Save"
                                                class="btn btn-flat btn-success" />

                                            <button type="button" data-next="telecommunication_facilities"
                                                class="btn btn-flat btn-primary"
                                                onClick="$('.nav-tabs > .active').next('li').find('a').trigger('click');"
                                                value="1" name="fencing_boundary"> Next</button>
                                        </div>
                                        <div>
                                            <br><br><br>
                                            <div class="clearfix"></div>
                                ...
                                <div class="tab-pane" id="telecommunication_facilities">
                                    <form
                                        ...
                                        <div class="col-md-3 pt-15">
                                            ...
                                            <button type="button" class="btn btn-flat btn-danger"
                                                onClick="$('.nav-tabs > .active').prev('li').find('a').trigger('click');"
                                                value="1" name="fencing_boundary"> Back</button>
                                            ...
                                            <button type="button" data-next="internal_transmission_system"
                                                class="btn btn-flat btn-primary"
                                                onClick="$('.nav-tabs > .active').next('li').find('a').trigger('click');"
                                                value="1" name="telecommunication_facilities"> Next</button>
                                        </div>
                                        <div>
                                            <br><br><br>
                                            <div class="clearfix"></div>
                                ...
                                <div class="tab-pane" id="internal_transmission_system">
                                    <form
                                        ...
                                        <div class="col-md-3 pt-15">
                                            ...
                                            <button type="button" class="btn btn-flat btn-danger"
                                                onClick="$('.nav-tabs > .active').prev('li').find('a').trigger('click');"
                                                value="1" name="telecommunication_facilities"> Back</button>
                                ...
                                <div class="tab-pane" id="solar_projects">
                                    <form
                                        ...
                                        <div class="col-md-3 pt-15">
                                            ...
                                            <button type="button" class="btn btn-flat btn-danger"
                                                onClick="$('.nav-tabs > .active').prev('li').find('a').trigger('click');"
                                                value="1" name="external_transmission_system"> Back</button>
                                ...
                                <div class="tab-pane" id="financial_closure">
                                    <form
                                        ...
                                        <div class="col-md-3 pt-15">
                                            ...
                                            <button type="button" data-next="award_of_work"
                                                class="btn btn-flat btn-primary"
                                                onClick="$('.nav-tabs > .active').next('li').find('a').trigger('click');"
                                ...
                                <div class="tab-pane" id="solar_park_completion">
                                    <form
                                        ...
                                        <div class="col-md-3 pt-15">
                                            ...
                                            <input type="hidden" name="next" value="external_power_evacuation_system"
                                                id="">
                                            <button type="button" class="btn btn-flat btn-danger"
                                                onClick="$('.nav-tabs > .active').prev('li').find('a').trigger('click');"
                                ...
                                <div class="tab-pane" id="external_power_evacuation_system">
                                    <form
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="col-md-3 pt-15">
                                            <input type="hidden" name="type" value="external_power_evacuation_system"
                                                id="">
