            ...
            <div class="col-md-12 ">
                <div class="row   register_form">
                    <div class="col-xl-12">
                        ...
                        <form action="{{URL::to(Auth::getDefaultDriver().'/new-reia-progress-report/')}}" method="post">
                            @csrf
                            <div class="row ">
                                <div class="col-md-12 progress_report_form"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                            <label class="pb-2" for="name"><strong>Scheme Name <span
                                        ...
                                        <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                            <label class="pb-2" for="name"><strong>Tender Capacity ( MW ) <span
                                                        class="text-danger">*</span></strong></label>
                                            <div style="position: relative;">
                                                <input placeholder="Tender Capacity ( MW )" name="tender_capacity"
                                                    id="tender_capacity" type="text" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                            <label class="pb-2" for="name"><strong>Bidder Name <span
                                                        class="text-danger">*</span></strong></label>
                                            <div style="position: relative;">
                                        ...
                                        <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                            <label class="pb-2" for="name"><strong>Bidder Capacity ( MW )<span
                                                        class="text-danger">*</span></strong></label>
                                            <div style="position: relative;">
                                                <input placeholder="Bidder Capacity ( MW )" name="bidder_capacity"
                                                    id="bidder_capacity" type="text" class="form-control"
                                                    value="{{$reia->bidder_capacity??''}}">
                                            </div>
                                        </div>
                                        <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                            <label class="pb-2" for="name"><strong>Date of PPA <span
                                                        class="text-danger">*</span>
                                                </strong></label>
                                            <div style="position: relative;">
                                                <input placeholder="Date of Notice inviting Tender" name="ppa_date"
                                                    id="ppa_date" type="date" class="form-control">
                                            </div>
                                        </div><!-- comment -->
                                        <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                            <label class="pb-2" for="name"><strong>PPA Capacity ( MW )<span
                                                        class="text-danger">*</span>
                                                </strong></label>
                                            <div style="position: relative;">
                                                <input placeholder="Date of Notice inviting Tender ( MW )"
                                                    name="ppa_capacity" id="ppa_capacity" type="text"
                                                    class="form-control" value="{{$reia->ppa_capacity??''}}">
                                            </div>
                                        </div><!-- comment -->
                                        <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                        ...
                                        <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                            ...
                                            <div style="position: relative;">
                                                <textarea type="text" placeholder="Present Status" name="status"
                                                    id="status" type="textarea" class="form-control"
                                                    value=""></textarea>
                                            </div>
                                        </div>

                                        <div class="col-xxl-12 text-center pt-3 pb-3">
                                            <input type="submit" id="submit" name="save" class="mt-1 btn btn-success"
                                                value="Save as draft">
                                            <input type="submit" id="submit" name="submit" class="mt-1 btn btn-success"
                                                value="Submit">
