<div id="home" class=" tab-pane active">
    <h5> <label class="headLebels">Tender</label></h5>
    <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('tender','{{$generalData["month"]}}','{{$generalData["year"]}}','{{$generalData["id"]}}')">
        Same
        as Previous Month
        <br>
    </div><br>
    <div class="col-md-4 col-sm-12">
        <label>Tendered Capacity (MW)<span class="text-danger">*</span></label>
    ...
    <div class="col-md-4 col-sm-12">
        <label>Date of RFS <span class="text-danger">*</span></label>
        <div class="input-group date">
            <div class="input-group-addon">
                <i class="fa fa-calendar"></i>
            </div>
    ...
    <div class="col-md-4 col-sm-12">
        <label>Date of Pre Bid Meeting<span class="text-danger">*</span></label>
        <div class="input-group date">
            <div class="input-group-addon">
                <i class="fa fa-calendar"></i>
            </div>
    ...
    <div class="col-md-4 col-sm-12">
        <label>Last date of Bid Submission<span class="text-danger">*</span></label>
        <div class="input-group date">
            <div class="input-group-addon">
                <i class="fa fa-calendar"></i>
            </div>
