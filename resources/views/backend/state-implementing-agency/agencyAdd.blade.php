        ...
        <section class="section dashboard form_sctn">
            <div class="col-xxl-12 col-xl-12 custm_cmn_form_stng">
                <div class="row ">
                    ...
                    <form action="{{URL::to(Auth::getDefaultDriver().'/Agency/Add')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 pb-3">
                                ...
                                <div class=""><input type="text" name="agency_name" id="agency_name"
                                        class="form-control" placeholder="Enter Agency Name"
                                        value="{{$agencydetails->agency_name ?? ''}}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 pb-3">
                                <div class=""><label>Contact Person Name <span class="text-danger">*</span></label>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 pb-3">
                                <div class=""><label>Contact Person Email <span class="text-danger">*</span></label>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 pb-3">
                                <div class=""><label>Contact Person Number <span class="text-danger">*</span></label>
                                </div>
                                <div class=""><input type="text" minlength="10" maxlength="10"
                                        ...
                                        value="{{$agencydetails->contact_person_number ?? ''}}"
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-12 pb-3">
                                ...
                                <div class=""> <textarea name="agency_address" id="agency_address" cols="30" rows="5"
                                        class="form-control">{{$agencydetails->agency_address ?? ''}}</textarea></div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 pb-3">
                                ...
                                <div class=""><select class="form-control" id="txtState" name="state"
                                        ...
                                        <option value="{{$state->code }}" @if(isset($agencydetails->state )
                                            && $state->
                                            code==$agencydetails->state)selected
                                            @endif>
                                            {{$state->name }}
                                        </option>
                                        @endforeach
...
$(document).ready(function() {
    getDistrictByState('{{ $agencydetails->state }}',
