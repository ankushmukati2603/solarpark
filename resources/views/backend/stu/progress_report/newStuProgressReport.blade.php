            ...
            <form action="{{URL::to(Auth::getDefaultDriver().'/add-stu-project')}}" method="post">
                ...
                <div class="row">
                    <div class="form-group col-lg-6">
                        ...
                        <div style="position: relative;">
                            <input placeholder="Tender/ Bidding Agency for RE Projects, if any" name="project_name"
                                type="text" class="form-control" value="{{$editedStuData->project_name ?? ''}}">
                        </div>
                    </div>
                    <div class=" form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group mb-3">
                            <input placeholder="Capacity for connectivity applied (MW)" name="developer_name"
                                type="number" step="any" class="form-control"
                                value="{{$editedStuData->developer_name ?? ''}}">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group mb-3">
                            <input placeholder="PAN Number" name="pan_no" id="number" type="password"
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div style="position: relative;">
                            <!-- <i class="fa-solid fa-chevron-down"></i> -->
                            <select class="form-control  required select21" id="sub_district_id" name="sub_district_id"
                    ...
                    <div class="d-grid">
                        ...
                        <button type="submit" class="btn btn-success btn-lg" name="submit" id='submit'>Submit</button>
                    </div>
