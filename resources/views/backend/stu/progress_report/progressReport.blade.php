                            ...
                            <div class="row">
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <div style="position: relative;">
                                        <input placeholder="Tender/ Bidding Agency for RE Projects, if any" name="tender_bidding_agency" type="text"
                                            class="form-control" value="{{$editProgressData->tender_bidding_agency ?? ''}}">
                                    </div>
                                    <span class="text-danger">{{ $errors->first('tender_bidding_agency') }}</span>
                                </div></br>
                                ...
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <div style="position: relative;">
                                        <input placeholder="Project Details (Name of Developer)" name="developer_name" type="text"
                                            class="form-control" value="{{$editProgressData->developer_name ?? ''}}">
                                    </div>
                                ...
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input placeholder="Capacity for connectivity applied (MW)" name="capacity_connectivity" type="text"
                                            class="form-control" value="{{$editProgressData->capacity_connectivity ?? ''}}">
                                    </div>
                                    <span class="text-danger">{{ $errors->first('capacity_connectivity') }}</span>
                                </div></br>
                                ...
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <select class="form-control" id="state_id" name="state_id" onchange="getDistrictByState(this.value, '')">
                                        ...
                                        <option value="{{$state->code}}"  @if($editProgressData->state_id == $state->code) selected @endif>{{$state->name}}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                ...
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <select class="form-control" id="connectivity_basis" name="connectivity_basis" >
                                        ...
                                        <option value="LTA"  @if($editProgressData->connectivity_basis == 'LTA') selected @endif >LTA</option>
                                        <option value="PPA" @if($editProgressData->connectivity_basis == 'PPA') selected @endif >PPA</option>
                                        <option value="BG" @if($editProgressData->connectivity_basis == 'BG') selected @endif >BG</option> 
                                        <option value="LAND" @if($editProgressData->connectivity_basis == 'LAND') selected @endif >LAND</option>
                                    </select>
                                    <span class="text-danger">{{ $errors->first('connectivity_basis') }}</span>
                                </div></br>
                                ...
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <div style="position: relative;">
                                        <input name="lta_operationalization_date" id="lta_operationalization_date" type="date"
                                               class="form-control" value="{{$editProgressData->lta_operationalization_date ?? ''}}">
                                    </div>
                                    <span class="text-danger">{{ $errors->first('lta_operationalization_date') }}</span>
                                </div></br>
                                ...
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <span class="text-danger">{{ $errors->first('capacity_commissioned') }}</span>
                                </div></br>
                                ...
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <span class="text-danger">{{ $errors->first('cumulative_capacity') }}</span>
                                </div></br>
                                ...
                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                    ...
                                    <span class="text-danger">{{ $errors->first('cumulative_capacity_date') }}</span>
                                </div></br>
