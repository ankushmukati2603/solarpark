    ...
    <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" style="position: relative;">
                <img src="{{ URL::asset('public/images/hrd_mainimg.jpg')}}" alt="" class="d-block" style="width:100%">
                <div class="carousel-caption">
                    <h3>Investing in Clean <br>
                        <span>Energy</span> Generation
                    </h3>
                    <!-- <p>Lorem Ipsum is simply dummy text</p> -->
                    <!-- <a href="{{URL::to('/user-registration')}}" class="btn btn-success btn-lg"
                        style="margin-right: 8px;">Register</a> -->
                    <!-- <a href="{{URL::to('/login-type')}}" class="btn btn-outline-success btn-lg"
            ...
            <div class="col-xl-11">
                <div class="row">
                    <div class="col-lg-3 counter0" style="padding: 0;">
                        <img src="{{ URL::asset('public/images/wind.jpg')}}" class="img-fluid">

                    </div>
                    <div class="col-lg-3 col-md-4 counter1">
                        <div class="cmn_stng">
                            <img src="{{ URL::asset('public/images/counter2.png')}}" class="counter_img_cmn">
                            <!-- <img src="{{ URL::asset('public/images/counter1.png')}}" class="counter_img_cmn"> -->
                    ...
                    <div class="col-lg-3 col-md-4 counter1">
                        <div class="cmn_stng">
                            <img src="{{ URL::asset('public/images/counter3.png')}}" class="counter_img_cmn">
                            <p class="value" akhi="">0</p>
    ...
    <div class="container-fluid px-5 pt-3 pb-5">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-12 animatedParent">
                <img src="{{ URL::asset('public/images/all_programs.png')}}" class="img-fluid animated fadeInLeft go">
            </div>
...
<!-- <section class="animatedParent">
    <img src="{{ URL::asset('public/images/banner_hrd.png')}}" class="img-fluid animated fadeInDownShort"
        style="width: 100%;">
</section>
                    ...
                    <div class="slide">
                        <div class="row pb-4">
                            <div class="col-lg-4 col-md-12 tstmnl_image_blk"><img
                                    src="{{ URL::asset('public/images/tstmnl_image.png')}}" class="img-fluid">
                            </div>
