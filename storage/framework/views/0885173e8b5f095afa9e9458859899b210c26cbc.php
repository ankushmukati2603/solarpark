        ...
        <div class="col-xxl-12 col-xl-12 custm_cmn_form_stng">
            <div class="row ">
                <div class="pagetitle col-xl-12">
                    ...
                    <form action="<?php echo e(URL::to(Auth::getDefaultDriver().'/Under-Implementation')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
$('#bidders').on('change', function() {
    ...
    if (bidders) {
        $.ajax({
            type: 'GET',
            url: baseUrl + '/<?php echo e(Auth::getDefaultDriver()); ?>/ajaxSelectedBidderRecords/' + bidders + '/' +
                tender_id,
            success: function(data) {
                $('#loading-bg-ajax').addClass('hide');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\solar_park\resources\views/backend/state-implementing-agency/underImplementation.blade.php ENDPATH**/ ?>