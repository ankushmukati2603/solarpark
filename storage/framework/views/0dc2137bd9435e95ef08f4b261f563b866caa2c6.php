        ...
        <section class="section dashboard form_sctn">
            <div class="col-xxl-12 col-xl-12 custm_cmn_form_stng">
                <div class="row ">
                    ...
                    <form action="<?php echo e(URL::to(Auth::getDefaultDriver().'/ReverseAuction')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row" style="display:none" id="reversTable">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 pb-3">
                                ...
                                <div class=""><select name="ra_type" id="ra_type" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\solar_park\resources\views/backend/state-implementing-agency/reverseAuction.blade.php ENDPATH**/ ?>