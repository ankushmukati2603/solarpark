                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body grdnt3">
                                    <div class="postn_reltv">
                                        ...
                                        <div class=" pb-3">
                                            <h6>Capacity Under Implementation </h6>
                                            <a href="#"><span class="more_info small pt-2 ps-1">more info <i
                                                        class="fa-solid fa-angle-right"></i></span></a>
                                        </div>
                                    </div>
                            ...
                            <div class="card info-card sales-card">
                                <div class="card-body grdnt4">
                                    <div class="postn_reltv">
                                        ...
                                        <div class=" pb-3">
                                            <h6>Capacity Under Tendering </h6>
                                            <a href="#"><span class="more_info small pt-2 ps-1">more info <i
                                                        class="fa-solid fa-angle-right"></i></span></a>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\solar_park\resources\views/backend/beneficiary/dashboard.blade.php ENDPATH**/ ?>