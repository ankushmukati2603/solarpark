<div id="home" class=" tab-pane active"><br>
    <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('award_of_work','<?php echo e($generalData["month"]); ?>','<?php echo e($generalData["year"]); ?>','<?php echo e($generalData["id"]); ?>')">
        Same
        as Previous Month
        <br>
    </div>
    ...
    <div class="col-md-12 pb-4">
        ...
        <textarea name="award_work_details" id="" cols="10" class="form-control"
            rows="2"><?php echo e($generalData['award_of_work']['award_work_details'] ?? ''); ?></textarea>
        <span class="text-danger"><?php echo e($errors->first('award_work_details')); ?></span>
    </div>
    <div class="col-sm-12">
        ...
        <div class="form-check-inline">
            <label class="form-check-label">
                <input type="radio" class="form-check-input" name="whether_awarded" value="A"
                    <?php if(($generalData['award_of_work']['whether_awarded'] ?? '' )=='A' ): ?> checked <?php endif; ?> checked> Yes
            </label>
        </div>
        <div class="form-check-inline">
            <label class="form-check-label">
                <input type="radio" class="form-check-input" name="whether_awarded" value="B"
                    <?php if(($generalData['award_of_work']['whether_awarded'] ?? '' )=='B' ): ?> checked <?php endif; ?>> No
            </label>
        </div>
    </div><br>
    <div class="col-md-12 pb-4">
        ...
        <textarea name="pooling_stations" id="" cols="10" class="form-control"
            rows="2"><?php echo e($generalData['award_of_work']['pooling_stations'] ?? ''); ?></textarea>
        <span class="text-danger"><?php echo e($errors->first('pooling_stations')); ?></span>
    </div>
    <div class="col-md-12 pb-4">
        ...
        <textarea name="aow_status" id="" cols="10" class="form-control"
            rows="2"><?php echo e($generalData['award_of_work']['aow_status'] ?? ''); ?></textarea>
        <span class="text-danger"><?php echo e($errors->first('aow_status')); ?></span>
    </div>
    <div class="col-md-12 pb-4">
        ...
        <textarea name="work_award_remarks" id="" cols="10" class="form-control"
            rows="2"><?php echo e($generalData['award_of_work']['work_award_remarks'] ?? ''); ?></textarea>
        <span class="text-danger"><?php echo e($errors->first('work_award_remarks')); ?></span>
    </div>
</div><?php /**PATH D:\xampp_new\htdocs\solar_park\resources\views/backend/beneficiary/progress_report/award_of_work.blade.php ENDPATH**/ ?>