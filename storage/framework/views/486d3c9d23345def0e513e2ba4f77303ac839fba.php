                        ...
                        <form action="<?php echo e(route('login')); ?>" method="POST" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group1 col-lg-12">
                                    <input placeholder="Mobile number" type="text" maxlength="10"
                                        onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="number"
                                        name="contact_no" class="form-control" autocomplete="off" style="display: none">
                                    <input placeholder="Email" type="text" id="txtemail" name="email"
                                        class="form-control">
                                    <span class="text-danger"><?php echo e($errors->first('email')); ?></span>
                                </div>
                                <div class="form-group1 col-lg-12">
                                    <div class="input-group mb-344 input-group-lg">
                                ...
                                <input type="hidden" name="user_type" id="user_type" value="BENEFICIARY_EMAIL">
...
$("input[type='radio']").change(function() {
    ...
    if ($(this).val() == "email") {
        ...
        $("#otpSend").hide();
        $("#submitted").show();
        $('#user_type').val('BENEFICIARY_EMAIL');
        ...
        $("#otpSend").show();
        $("#submitted").hide();
        $('#user_type').val('BENEFICIARY_MOBILE');
    }
...
function loginOtp() {
    ...
    if (number) {
        $.ajax({
            type: 'GET',
            url: baseUrl + '/ajax/login-otp/' + number,
...
function userOTPVerified() {
    ...
    if (otp) {
        $.ajax({
            type: 'GET',
            url: baseUrl + '/ajax/user-verify-otp/' + number + '/' + otp,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.masters.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\solar_park\resources\views/userLogIn.blade.php ENDPATH**/ ?>