...
<div id="home" class=" tab-pane active"><br>
    <!-- <div style="float: right;"><input type="checkbox" class="checkoption" value="general"
            onchange="getLastMonthReportData('attachments','<?php echo e($generalData["month"]); ?>','<?php echo e($generalData["year"]); ?>','<?php echo e($generalData["id"]); ?>')">
        Same
        as Previous Month
        <br>
    </div> -->
    ...
    <div class="col-md-12 pb-4">
        ...
        <input type="file" name="site_photo[]" id="site_photo"
            value="<?php echo e($generalData['attachments']['site_photo']['site_photo']  ?? ''); ?>" accept='image/jpeg ,image/png'
        ...
        <?php if(!empty($generalData['attachments']['site_photo'])): ?>
        <?php $i=0; ?>
        <?php $__currentLoopData = $generalData['attachments']['site_photo'][$i]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(URL::to($docBaseUrl.$value)); ?>" target="_blank" style='margin:5px'><i
    ...
    <div class="col-md-12 pb-4">
        ...
        <label for="" class="text-primary">Multiple pictures are allowed to upload only in PNG, JPEG format</label>
        <?php if(!empty($generalData['attachments']['road_photo'])): ?>
        <?php $j=0; ?>
        <?php $__currentLoopData = $generalData['attachments']['road_photo'][$j]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- <a href="<?php echo e($value); ?>">View File |</a> -->
        <a href="<?php echo e(URL::to($docBaseUrl.$value)); ?>" target="_blank" style='margin:5px'><i
                class="fa-solid fa-image text-danger fa-2x"></i></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
    ...
    <div class="col-md-12 pb-4">
        ...
        <label for="" class="text-primary">Multiple pictures are allowed to upload only in PNG, JPEG format</label>
        <?php if(!empty($generalData['attachments']['ipes_photo'])): ?>
        <?php $l=0; ?>
        <?php $__currentLoopData = $generalData['attachments']['ipes_photo'][$l]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- <a href="<?php echo e($value); ?>">View File |</a> -->
        <a href="<?php echo e(URL::to($docBaseUrl.$value)); ?>" target="_blank" style='margin:5px'><i
                class="fa-solid fa-image text-danger fa-2x"></i></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        <span class="text-danger"><?php echo e($errors->first('ipes_photo')); ?></span>
    </div>
    ...
    <div class="col-md-12 pb-4">
        ...
        <label for="" class="text-primary">Multiple pictures are allowed to upload only in PNG, JPEG format</label>
        <?php if(!empty($generalData['attachments']['exts_photo'])): ?>
        <?php $m=0; ?>
        <?php $__currentLoopData = $generalData['attachments']['exts_photo'][$m]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e(URL::to($docBaseUrl.$value)); ?>" target="_blank" style='margin:5px'><i
                class="fa-solid fa-image text-danger fa-2x"></i></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        <span class="text-danger"><?php echo e($errors->first('exts_photo')); ?></span>
    </div>
    <div class="col-md-12 pb-4">
        ...
        <label for="" class="text-primary">Multiple pictures are allowed to upload only in PNG, JPEG format</label>
        <?php if(!empty($generalData['attachments']['solar_project_photo'])): ?>
        <?php $n=0; ?>
        <?php $__currentLoopData = $generalData['attachments']['solar_project_photo'][$n]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- <a href="<?php echo e($value); ?>">View File </a> -->
        <a href="<?php echo e(URL::to($docBaseUrl.$value)); ?>" target="_blank" style='margin:5px'><i
                class="fa-solid fa-image text-danger fa-2x"></i></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        <span class="text-danger"><?php echo e($errors->first('solar_project_photo')); ?></span>
    </div>
    <!-- added new -->
    ...
    <div class="col-md-12 pb-4">
        ...
        <?php if(!empty($generalData['attachments']['additional_documents'])): ?>
        <?php $O=0; ?>
        <?php $__currentLoopData = $generalData['attachments']['additional_documents'][$O]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- <a href="<?php echo e($value); ?>">View File </a> -->
        <a href="<?php echo e(URL::to($docBaseUrl.$value)); ?>" target="_blank" style='margin: 5px;'>
            <i class="fa-solid fa-file text-danger fa-2x"></i></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        <span class="text-danger"><?php echo e($errors->first('additional_documents')); ?></span>
    </div>
...
</script><?php /**PATH D:\xampp_new\htdocs\solar_park\resources\views/backend/beneficiary/progress_report/attachments.blade.php ENDPATH**/ ?>