                                    ...
                                    <div class="postn_reltv">
                                        ...
                                        <div class="card-icon   card1 ">
                                            <div class="number_stng ">
                                                <span><?php echo e($data['total_capacity_tendered']/1000); ?> GW</span>
                                            </div>
                                        </div>
                                        <div class=" pb-3">
                                            <h6>Total <br> capacity tendered</h6>
                                            <a href="<?php echo e(URL::to(Auth::getDefaultDriver().'/capacity-tendered-list')); ?>"><span
                                ...
                                <div class="card-body grdnt2">
                                    <div class="postn_reltv">
                                        ...
                                        <div class="card-icon   card2">
                                            <div class="number_stng ">
                                                <span><?php echo e($data['total_capacity_under_implementation']); ?></span>
                                            </div>
                                        </div>
                                        <div class=" pb-3">
                                ...
                                <div class="card-body grdnt3">
                                    <div class="postn_reltv">
                                        ...
                                        <div class="card-icon   card3">
                                            <div class="number_stng ">
                                                <span><?php echo e($data['total_capacity_commissioned']); ?></span>
                                            </div>
                                        </div>
                                        <div class=" pb-3">
                                ...
                                <div class="card-body grdnt5">
                                    <div class="postn_reltv">
                                        ...
                                        <div class="card-icon   card5">
                                            <div class="number_stng "><span><?php echo e($data['cancelled_tenders']); ?></span>
                                            </div>
                                        </div>
                                        <div class=" pb-3">
                                            <h6>Cancelled <br> Tenders</h6>
                                            <a href="<?php echo e(URL::to(Auth::getDefaultDriver().'/cancelled-tender-list')); ?>"><span
                                                    class="more_info small pt-2 ps-1">more info <i
                                                        class="fa-solid fa-angle-right"></i></span></a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body grdnt6">
                                    <div class="postn_reltv">
                                        ...
                                        <div class="card-icon   card6">
                                            <div class="number_stng ">
                                                <span><?php echo e($data['tenders_under_implementation']); ?></span>
                                            </div>
                                        </div>
                                        <div class=" pb-3">
                                ...
                                <div class="card-body grdnt7">
                                    <div class="postn_reltv">
                                        ...
                                        <div class="card-icon card7">
                                            <div class="number_stng "><span><?php echo e($data['tenders_commissioned']); ?></span>
                                            </div>
                                        </div>
                                        <div class=" pb-3">
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\solar_park\resources\views/backend/mnre/dashboard.blade.php ENDPATH**/ ?>