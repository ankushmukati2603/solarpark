...
<section class="section dashboard">
    ...
    <main id="main" class="main">
        ...
        <table border="1" cellspacing="0" cellpadding="5" class="table table-bordered table-striped text-left">
            ...
            <tr>
                <th>DPR Status</th>
                <td> <?php if($previewData['internal_infrastructure']['dpr_status'] == 'A'): ?>
                    <span>DPR Under Preparation</span>
                    <?php elseif($previewData['internal_infrastructure']['dpr_status'] == 'B'): ?>
                    <span>DPR Submitted</span>
                    <?php elseif($previewData['internal_infrastructure']['dpr_status'] == 'C'): ?>
            ...
            <tr>
                ...
                <td>
                    <?php if($previewData['internal_infrastructure']['govt_land'] == 'A'): ?>
                    <span>Land Identified</span>
            ...
            <tr>
                <th>Private Land</th>
                <td><?php if($previewData['internal_infrastructure']['private_land'] == 'A'): ?>
                    <span>Land Identified</span>
            ...
            <tr>
                ...
                <td> <?php if($previewData['road']['road_status'] == 'A'): ?>
                    <span>Already available</span>
                    <?php elseif($previewData['road']['road_status'] == 'B'): ?>
                ...
                <td><?php echo e($previewData['road']['park_boundary'] ?? ''); ?>

                </td>
            </tr>
            <tr>
                <th>Length of access road to each plot inside the park (in km)</th>
                <td><?php echo e($previewData['road']['road_distance'] ?? ''); ?></td>
                <th>Status </th>
                <td><?php echo e($previewData['road']['work_status'] ?? ''); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td><?php echo e($previewData['water_facilities']['source_water'] ?? ''); ?></td>
                <th>Details of water requirements</th>
                <td><?php echo e($previewData['water_facilities']['required_water'] ?? ''); ?>

                </td>
            </tr>
            <tr>
                <th>Proposed system and progress made so far</th>
                <td><?php echo e($previewData['water_facilities']['proposed_system'] ?? ''); ?></td>
                <th>Status </th>
                <td><?php echo e($previewData['water_facilities']['status'] ?? ''); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td><?php echo e($previewData['drainage_system']['drainage_system_details'] ?? ''); ?></td>
                <th>Status </th>
                <td><?php echo e($previewData['drainage_system']['tender_status'] ?? ''); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td> <?php echo e($previewData['fencing_boundary']['fencing_details'] ?? ''); ?></td>
                <th>Status </th>
                <td><?php echo e($previewData['fencing_boundary']['fencing_status']  ?? ''); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td> <?php echo e($previewData['telecommunication_facilities']['tele_facility_details'] ?? ''); ?></td>
                <th>Status </th>
                <td><?php echo e($previewData['telecommunication_facilities']['tender_progress_status']  ?? ''); ?></td>
            </tr>
            ...
            <tr>
                ...
                <td> <?php if($previewData['external_transmission_system']['ext_responsibility'] == 'A'): ?>
                    <span>CTU</span>
                    <?php else: ?>
                    <span>STU</span>
                    <?php endif; ?>
                ...
                <td> <?php echo e($previewData['external_transmission_system']['external_details'] ?? ''); ?></td>
            </tr>
            <tr>
                <th>Status</th>
                <td colspan="3"><?php echo e($previewData['external_transmission_system']['external_status']  ?? ''); ?></td>
            </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\solar_park\resources\views/backend/mnre/previewProgressReport.blade.php ENDPATH**/ ?>