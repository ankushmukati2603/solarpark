...
<section class="section dashboard">
    ...
    <main id="main" class="main">
        ...
        <td><?php echo e($previewData['financial_closure']['financial_closure_remarks']  ?? ''); ?></td> -->
            ...
            <tr>
                <th colspan="2">Remark : <?php echo e($previewData['remarks'] ?? ''); ?></th>
                <th colspan="2">Date/Time : <?php echo e($previewData['mnre_remark_date'] ?? ''); ?></th>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <textarea name="mnreremarks" class="form-control" id="" cols="5" rows="3"></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <input type="hidden" name="editId" value="<?php echo e($general->encodeid($previewData->id)); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\solar_park\resources\views/backend/mnre/SolarParkReport/solarParkProgressReportPreview.blade.php ENDPATH**/ ?>