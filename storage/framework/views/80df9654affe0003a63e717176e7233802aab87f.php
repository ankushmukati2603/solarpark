                                        ...
                                        <form action="<?php echo e(URL::to(Auth::getDefaultDriver().'/new-stu-progress_report')); ?>"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <div style="position: relative;">
                                                        <input
                                                            ...
                                                            class="form-control"
                                                            value="<?php echo e($editProgressData->tender_bidding_agency ?? ''); ?>">
                                                    </div>
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('tender_bidding_agency')); ?></span>
                                                </div></br>
                                                ...
                                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <div style="position: relative;">
                                                        <input placeholder="Project Details (Name of Developer)"
                                                            ...
                                                            value="<?php echo e($editProgressData->developer_name ?? ''); ?>">
                                                    </div>
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('developer_name')); ?></span>
                                                </div></br>
                                                ...
                                                <div class="form-group col-xl-3 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('capacity_connectivity')); ?></span>
                                                </div></br>
                                                ...
                                                <div class="form-group col-xl-4 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <div style="position: relative;">
                                                        <select class="form-control" id="state_id" name="state_id"
                                                            ...
                                                            <option value="<?php echo e($state->code); ?>" <?php if($editProgressData->
                                                                state_id == $state->code): ?> selected
                                                                <?php endif; ?>><?php echo e($state->name); ?></option>
                                                ...
                                                <div class="form-group col-xl-4 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('sub_district_id')); ?></span>
                                                </div></br>
                                                ...
                                                <div class="form-group col-xl-4 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <select class="form-control" id="connectivity_basis"
                                                        ...
                                                        <option value="LTA" <?php if($editProgressData->connectivity_basis ==
                                                            'LTA'): ?> selected <?php endif; ?> >LTA</option>
                                                        <option value="PPA" <?php if($editProgressData->connectivity_basis ==
                                                            'PPA'): ?> selected <?php endif; ?> >PPA</option>
                                                        <option value="BG" <?php if($editProgressData->connectivity_basis ==
                                                            'BG'): ?> selected <?php endif; ?> >BG</option>
                                                        <option value="LAND" <?php if($editProgressData->connectivity_basis
                                                            == 'LAND'): ?> selected <?php endif; ?> >LAND</option>
                                                    </select>
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('connectivity_basis')); ?></span>
                                                </div></br>
                                                ...
                                                <div class="form-group col-xl-4 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <div style="position: relative;">
                                                        <input name="lta_operationalization_date"
                                                            ...
                                                            class="form-control"
                                                            value="<?php echo e($editProgressData->lta_operationalization_date ?? ''); ?>">
                                                    </div>
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('lta_operationalization_date')); ?></span>
                                                </div></br>
                                                ...
                                                <div class="form-group col-xl-4 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('capacity_commissioned')); ?></span>
                                                </div></br>
                                                ...
                                                <div class="form-group col-xl-4 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('cumulative_capacity')); ?></span>
                                                </div></br>
                                                ...
                                                <div class="form-group col-xl-4 col-lg-4 col-md-6  pb-3">
                                                    ...
                                                    <span
                                                        class="text-danger"><?php echo e($errors->first('cumulative_capacity_date')); ?></span>
                                                </div></br>
