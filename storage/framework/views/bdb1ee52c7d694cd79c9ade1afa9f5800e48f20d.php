                        ...
                        <form action="<?php echo e(URL::to(Auth::getDefaultDriver().'/feedback')); ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 pb-3">
                                    ...
                                    <div class=""><input type="text" class="form-control" readonly
                                            value="<?php echo e(Auth::user()->contact_no ?? ''); ?>">
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\solar_park\resources\views/backend/beneficiary/feedback.blade.php ENDPATH**/ ?>