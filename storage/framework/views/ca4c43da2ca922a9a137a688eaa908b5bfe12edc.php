                ...
                <div class="row ">
                    <div class="pagetitle col-xl-12">
                        ...
                        <table class="table table-bordered" id="example">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $cancelTenderList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($tender->agency_name ?? ''); ?></td>
...
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\solar_park\resources\views/backend/state-implementing-agency/__tenderCancelled.blade.php ENDPATH**/ ?>