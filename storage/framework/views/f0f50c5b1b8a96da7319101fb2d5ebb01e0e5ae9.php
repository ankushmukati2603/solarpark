...
$("#cancel_capacity").blur(function() {
    ...
    var ra_capacity = 0;
    if (cancel_capacity > tender_capacity) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\solar_park\resources\views/backend/state-implementing-agency/cancelTender.blade.php ENDPATH**/ ?>