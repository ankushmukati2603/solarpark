...
$('#bidders').on('change', function() {
    ...
    if (bidders) {
        $.ajax({
            type: 'GET',
            url: baseUrl + '/<?php echo e(Auth::getDefaultDriver()); ?>/getSelectedBidderProjectData/' + bidders +
                '/' +
                tender_id,
            success: function(data) {
                $('#bidderloader').html('');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.masters.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp_new\htdocs\solar_park\resources\views/backend/state-implementing-agency/projectLocation.blade.php ENDPATH**/ ?>