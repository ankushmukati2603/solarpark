<header id="header" class="header fixed-top d-flex align-items-center dashboard_header dashboard3">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="" class="logo d-flex align-items-center navbar-brand">
            <!-- <img src="<?php echo e(URL::asset('public/assets/images/solar-power-logo4.png')); ?>" alt=""> -->
            <span style="color: green;">
                <?php if(Auth::guard('developer')->check()): ?> <img
                    src="<?php echo e(URL::asset('public/assets/images/solar-park-logo.png')); ?>" alt="">
                <?php else: ?>
                <img src="<?php echo e(URL::asset('public/assets/images/solar-power-logo4.png')); ?>" alt="">
                <?php endif; ?>
            </span>
    ...
    <div class="gov-india other_logos">
        <img src="<?php echo e(URL::asset('public/images/govt_mnre_logo.png')); ?>" class="img-fluid">
        <a class=" other_logos azadi_logo"><img src="<?php echo e(URL::asset('public/images/azdi_ka_mohtsv.png')); ?>"
    ...
    <nav class="header-nav ms-auto">
        ...
        <li class="nav-item dropdown pe-3">
            ...
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                <img src="<?php echo e(URL::asset('public/images/profile-img.jpg')); ?>" alt="Profile" class="rounded-circle">
                <span class="d-none d-md-block dropdown-toggle ps-2"> <small>
                        Welcome</small><br><?php echo e(Auth::user()->name); ?></span>
            </a>
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li class="nav-item ">
            ...
            <a href="<?php echo e(route('log-out')); ?>" class="nav-link nav-icon"><i class="fa-solid fa-power-off"></i></a>
            <!-- <form method="POST" id="formAjax" action="<?php echo e(route('logout')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <nav class="header-nav ms-auto">
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="<?php echo e(asset('public/assets/img/profile-img.jpg')); ?>" alt="Profile" class="rounded-circle">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('privacy-policy')); ?>">
                            <i class="bi bi-person"></i>
                            <span>Privacy Policy</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('terms-of-use')); ?>">
                            <i class="bi bi-person"></i>
...
</header> --><?php /**PATH D:\xampp_new\htdocs\solar_park\resources\views/layouts/partials/backend/_header.blade.php ENDPATH**/ ?>